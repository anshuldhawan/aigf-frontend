...
<div className="myprof d-block d-lg-flex">
    ...
    <div className="prodesc">
        ...
        <p className="text-muted mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
        tempor incididunt ut labore et dolore magna aliqua.</p>
        <Link to="/chats" className="btn my-btn btn-primary">Chat With Me</Link>
    </div>
</div>

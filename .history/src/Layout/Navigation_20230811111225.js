          ...
          {!adminToken && (
            <>
              ...
              <li className="nav-item">
                <Link
                  className={`nav-link position-relative p-0 ${
                    path.includes("my-collections") && "active"
                  }`}
                  to="/my-collections"
                >
              ...
              <li className="nav-item">
                <Link
                  className={`nav-link position-relative p-0 ${
                    path.includes("buy-credits") && "active"
                  }`}
                  to="/buy-credits"
                >
                  <svg
